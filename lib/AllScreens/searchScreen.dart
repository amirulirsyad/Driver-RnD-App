...
import 'package:driver_rnd_app/AllWidgets/Divider.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void _refreshDiaries() async {
    ...
    var placeList = (predictions as List).map((e) => PlacePrediction.formJson(e)).toList();
    placePredictionList = placeList;
    setState(() {
      placePredictionList = data;
      _isLoading = false;
    });
  }*/
  ...
  void initState() {
    super.initState();
    findPlace(valCopy); // Loading the diary when the app starts
  }
  ...
  void findPlace(String placeName) async {
    //print("here "+placeName);
    if (placeName.length >= 1) {
      valCopy = placeName;
      String autoCompleteUrl =
          "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:my";
      ...
      if (res["status"] == "OK") {
        ...
        var placeList = (predictions as List)
            .map((e) => PlacePrediction.formJson(e))
            .toList();
        placePredictionList = placeList;

        setState(() {
          placePredictionList = placeList;
          print("test2" + placePredictionList.toString());
          _isLoading = false;
        });
        //print(res);
...
class PredictionTile extends StatelessWidget {
  ...
  void getPlaceAddressDetails(String placeId, context) async {
    ...
    if (res["status"] == "OK") {
      ...
      print("testADD" + address.toString());
